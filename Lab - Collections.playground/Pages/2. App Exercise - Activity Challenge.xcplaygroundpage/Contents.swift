...
let walkingChallenges: [String] = ["Walk 10,000 steps a day", "Morning 2 km walk"]
let runningChallenges: [String] = ["Run 5 km in under 30 minutes", "Daily 20-minute jog"]

let cyclingChallenges: [String] = ["Bike 15 km route", "Cycle to work for a week"]

print("Walking Challenges:", walkingChallenges)
print("Running Challenges:", runningChallenges)
print("Cycling Challenges:", cyclingChallenges)
...
let challenges: [[String]] = [walkingChallenges, runningChallenges, cyclingChallenges]
print(challenges[1][0])


//:  All of the challenges will reset at the end of the month. Use the `removeAll` to remove everything from `challenges`. Print `challenges`.
var challenges1 = ["Walk 10,000 steps", "Read a book", "Drink 2L water"]

challenges1.removeAll()
...
var committedChallenges1: [String] = ["Read 10 pages of a book"] // Try changing the items to test different branches
