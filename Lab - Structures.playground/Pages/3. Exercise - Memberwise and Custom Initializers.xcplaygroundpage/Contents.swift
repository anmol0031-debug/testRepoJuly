...
let favoriteBook = Book(title: "The Hobbit", author: "J.R.R. Tolkien", pages: 310, price: 9.99)
...
let laptop2 = Laptop(screenSize: 15, yearPurchased: 2020)

print("Laptop 1 = Screen Size: \(laptop1.screenSize)\", Year: \(laptop1.yearPurchased)")
print("Laptop 2 = Screen Size: \(laptop2.screenSize)\", Year: \(laptop2.yearPurchased)")
...
let heightFromInches = Height(inches: 65)
print("Height in inches: \(heightFromInches.heightInInches)")
print("Height in centimeters: \(heightFromInches.heightInCentimeters)")
