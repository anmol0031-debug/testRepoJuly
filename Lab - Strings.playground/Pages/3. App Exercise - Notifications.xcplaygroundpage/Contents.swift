...
let newBest = 15125
let fullName1 = "Anmol Mehta"

let congratulations = "Congratulations, \(fullName1)! You beat your previous daily high score of \(previousBest) steps by walking \(newBest) steps yesterday!"
