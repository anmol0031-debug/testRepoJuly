...
//with nil value
if let sum = add(nil, 3){
    print(sum)
}else{
    print("Encountered a null value")
}
...
if let newUser = createUser() {
    print("Created the user: \(newUser.firstName) \(newUser.lastName),age \(newUser.age)")
} else {
    print("Could not create the user :(")
}
