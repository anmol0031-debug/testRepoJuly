...
//print("The error that is recieved as -> Value of optional type 'Int?' must be unwrapped to a value of type 'Int'")
...
print(userAge!)
//print("As we had  given typo in the string that contained a letter 'e' which resulted in the conversion of the  number to int as the number string provided cant be converted to a number hence convereted to nil ")
